...
function seedIfEmpty() {
  ...
  if (Object.keys(state.menuItems).length === 0) {
    const items = [
      ...
      // ---- קוקטיילים ----
      { name: 'ניגרוני', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'negroni' },
      { name: 'מוחיטו', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'mojito' },
      { name: 'מרגריטה', description: 'טקילה בלנקו, מונין אגבה ולימון', ingredients: 'טקילה בלנקו, מונין אגבה ולימון', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'margarita' },
      { name: 'אפרול שפריץ', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'aperol-spritz' },
      { name: 'אבטיח-בול', description: 'וודקה סמירנוף, מונין אשכולית אדומה, נענע, רדבול ואבטיח', ingredients: 'וודקה סמירנוף, מונין אשכולית אדומה, נענע, רדבול ואבטיח', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'watermelon-bull' },
      { name: 'טרופיקנה', description: 'קפטן מורגן ספייסד, מונין מנגו, מיץ אננס ולימון', ingredients: 'קפטן מורגן ספייסד, מונין מנגו, מיץ אננס ולימון', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'tropicana-cocktail' },
      { name: 'זאוס', description: 'ויסקי רד לייבל, מונין וניל ושקדים, לימון', ingredients: 'ויסקי רד לייבל, מונין וניל ושקדים, לימון', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'zeus-cocktail' },
      { name: 'הענק הירוק', description: 'ג׳ין גורדונס, ורמוט, קיווי ולימון', ingredients: 'ג׳ין גורדונס, ורמוט, קיווי ולימון', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'green-giant' },
      { name: 'אפרודיטה', description: 'וודקה סמירנוף, אפרול, מונין אשכולית אדומה ולימון', ingredients: 'וודקה סמירנוף, אפרול, מונין אשכולית אדומה ולימון', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'aphrodite-cocktail' },
      { name: 'אנים', description: 'ערק שליט, מונין ליצ׳י, מיץ אננס ולימון', ingredients: 'ערק שליט, מונין ליצ׳י, מיץ אננס ולימון', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'anim-cocktail' },
      { name: 'פאלומה קוקטייל', description: 'טקילה אספלון בלנקו, אשכולית אדומה, לימון ונענע', ingredients: 'טקילה אספלון בלנקו, אשכולית אדומה, לימון ונענע', price: 56, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'paloma' },
      { name: '10 צ׳ייסרים', description: 'וודקה סמירנוף | ויסקי בלונדי | טקילה אספלון | ג׳ין גורדונס | ערק | קמפרי | פיג׳ | טובי 60', ingredients: 'וודקה סמירנוף, ויסקי בלונדי, טקילה אספלון, ג׳ין גורדונס, ערק, קמפרי, פיג׳, טובי 60 — 10 צ׳ייסרים לשולחן', price: 189, category: 'קוקטיילים', course: 'alcohol', imageSlug: 'chasers-10' },
      // ---- בקטנה ----
