...
function seedIfEmpty() {
  ...
  if (Object.keys(state.menuItems).length === 0) {
    const items = [
      ...
      // ---- בירות ----
      { name: 'קורונה', price: 36, category: 'בירות', course: 'alcohol', imageSlug: 'corona' },
      { name: 'קסטיל', price: 38, category: 'בירות', course: 'alcohol', imageSlug: 'castle' },
      { name: 'גינס (פחית)', price: 37, category: 'בירות', course: 'alcohol', imageSlug: 'guinness' },
      { name: 'שיקמה (חבית)', price: 33, category: 'בירות', course: 'alcohol', imageSlug: 'shikma' },
      { name: 'קרלסברג (חבית)', price: 33, category: 'בירות', course: 'alcohol', imageSlug: 'carlsberg' },
      { name: 'טובורג (חבית)', price: 33, category: 'בירות', course: 'alcohol', imageSlug: 'tuborg' },
      { name: 'וויינשטפן (חבית)', price: 33, category: 'בירות', course: 'alcohol', imageSlug: 'weihenstephan' },
      { name: 'לומה (חבית)', price: 33, category: 'בירות', course: 'alcohol', imageSlug: 'loma' },
      // ---- יין ומבעבעים (מחיר לכוס) ----
      { name: 'רוזה Artisanal', description: 'כוס', ingredients: 'יין רוזה, מוגש בכוס', price: 53, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'wine-rose' },
      { name: 'שרדונה Artisanal (לבן)', description: 'כוס', ingredients: 'יין לבן שרדונה, מוגש בכוס', price: 53, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'wine-chardonnay' },
      { name: 'מרלו Artisanal (אדום)', description: 'כוס', ingredients: 'יין אדום מרלו, מוגש בכוס', price: 49, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'wine-merlot' },
      { name: 'בלאן נאן גוורץ (לבן, כשר לפסח)', description: 'כוס', ingredients: 'יין לבן גוורצטרמינר, כשר לפסח', price: 58, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'wine-gewurztraminer' },
      { name: 'שבלי (לבן)', description: 'כוס', ingredients: 'יין לבן שבלי, מוגש בכוס', price: 59, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'wine-chablis' },
      { name: 'פינו נואר (אדום)', description: 'כוס', ingredients: 'יין אדום פינו נואר, מוגש בכוס', price: 54, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'wine-pinot-noir' },
      { name: 'קאווה פרוסקו שפריץ', description: 'כוס', ingredients: 'יין מבעבע קאווה עם שפריץ', price: 49, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'cava-spritz' },
      { name: 'שאטו דה מירבאל (כשר)', description: 'בקבוק בלבד', ingredients: 'יין בקבוק, כשר', price: 279, category: 'יין ומבעבעים', course: 'alcohol', allergens: ['סולפיטים'], imageSlug: 'wine-chateau-mirabel' },
      // ---- קוקטיילים ----
      { name: 'ניגרוני', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'negroni' },
      { name: 'מוחיטו', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'mojito' },
      { name: 'מרגריטה', description: 'טקילה בלנקו, מונין אגבה ולימון', ingredients: 'טקילה בלנקו, מונין אגבה ולימון', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'margarita' },
      { name: 'אפרול שפריץ', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'aperol-spritz' },
      { name: 'אבטיח-בול', description: 'וודקה סמירנוף, מונין אשכולית אדומה, נענע, רדבול ואבטיח', ingredients: 'וודקה סמירנוף, מונין אשכולית אדומה, נענע, רדבול ואבטיח', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'watermelon-bull' },
      { name: 'טרופיקנה', description: 'קפטן מורגן ספייסד, מונין מנגו, מיץ אננס ולימון', ingredients: 'קפטן מורגן ספייסד, מונין מנגו, מיץ אננס ולימון', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'tropicana-cocktail' },
      { name: 'זאוס', description: 'ויסקי רד לייבל, מונין וניל ושקדים, לימון', ingredients: 'ויסקי רד לייבל, מונין וניל ושקדים, לימון', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'zeus-cocktail' },
      { name: 'הענק הירוק', description: 'ג׳ין גורדונס, ורמוט, קיווי ולימון', ingredients: 'ג׳ין גורדונס, ורמוט, קיווי ולימון', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'green-giant' },
      { name: 'אפרודיטה', description: 'וודקה סמירנוף, אפרול, מונין אשכולית אדומה ולימון', ingredients: 'וודקה סמירנוף, אפרול, מונין אשכולית אדומה ולימון', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'aphrodite-cocktail' },
      { name: 'אנים', description: 'ערק שליט, מונין ליצ׳י, מיץ אננס ולימון', ingredients: 'ערק שליט, מונין ליצ׳י, מיץ אננס ולימון', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'anim-cocktail' },
      { name: 'פאלומה קוקטייל', description: 'טקילה אספלון בלנקו, אשכולית אדומה, לימון ונענע', ingredients: 'טקילה אספלון בלנקו, אשכולית אדומה, לימון ונענע', price: 56, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'paloma' },
      { name: '10 צ׳ייסרים', description: 'וודקה סמירנוף | ויסקי בלונדי | טקילה אספלון | ג׳ין גורדונס | ערק | קמפרי | פיג׳ | טובי 60', ingredients: 'וודקה סמירנוף, ויסקי בלונדי, טקילה אספלון, ג׳ין גורדונס, ערק, קמפרי, פיג׳, טובי 60 — 10 צ׳ייסרים לשולחן', price: 189, category: 'קוקטיילים', course: 'cocktails', imageSlug: 'chasers-10' },
      // ---- בקטנה ----
